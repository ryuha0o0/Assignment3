...
const { getAllJobs, getJobById, searchJobs, filterJobs, sortJobs, updateJob, createJob, deleteJob } = require('../controllers/jobsController');
...
router.put('/', authMiddleware, updateJob);
